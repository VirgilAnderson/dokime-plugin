...
4. **Project type** (optional) — A general description of the project context, anonymized. (e.g., "brownfield Laravel", "greenfield React", "data pipeline"). Do NOT include project names, company names, or identifying details.
