...
7. Check for **interaction bugs** — could the fix collide with other parts of the system? (e.g., label collisions, key overwrites, shared state)
8. Document the root cause in the spec file with file paths and line numbers
